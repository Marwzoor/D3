...
var dateParse = __WEBPACK_IMPORTED_MODULE_0_d3__["timeParse"]("%Y-%m-%d");

var x = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleTime"]().range([0, width]);
var y1 = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleLinear"]().range([height, 0]);
var y2 = __WEBPACK_IMPORTED_MODULE_0_d3__["scaleLinear"]().range([height, 0]);

var valueLine1 = __WEBPACK_IMPORTED_MODULE_0_d3__["line"]()
	.x(function (d) { return x(d.date); })
	.y(function (d) { return y1(d.humidity); });

var valueLine2 = __WEBPACK_IMPORTED_MODULE_0_d3__["line"]()
	.x(function (d) { return x(d.date); })
...
__WEBPACK_IMPORTED_MODULE_0_d3__["csv"]('data.csv', function (error, data) {
	...
	x.domain(__WEBPACK_IMPORTED_MODULE_0_d3__["extent"](data, function (d) { return d.date; }));
	y1.domain([0, __WEBPACK_IMPORTED_MODULE_0_d3__["max"](data, function (d) { return d.humidity; })]);
	y2.domain([0, __WEBPACK_IMPORTED_MODULE_0_d3__["max"](data, function (d) { return d.co2; })]);
	...
	svg.append("g")
		.attr("class", "humidity")
		.call(__WEBPACK_IMPORTED_MODULE_0_d3__["axisLeft"](y1)
			.ticks(5)
	...
	svg.append("g")
		...
		.call(__WEBPACK_IMPORTED_MODULE_0_d3__["axisRight"](y2)
			.ticks(5)
